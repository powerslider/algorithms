    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < queriesCount; i++) {
            ...
            switch (queryType) {
                case 1:
                    // push to main stack
                    stack.push(queryInput);
                    if (!maxStack.isEmpty()) {
                        // maintain an alternative stack that is descendingly sorted
                        ...
                        // same length on both stacks in order for the max stack to keep the
                        // current maximum even after a pop query on both stacks
